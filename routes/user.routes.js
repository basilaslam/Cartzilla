...
router.post('/wallet/addMoney/stripe', userCtrl.sessionCheck, userCtrl.makePayment);
router.get('/wallet/addMoney/stripe/payment', userCtrl.sessionCheck, userCtrl.addMoneyToWallet);
router.post('/user/walletBalance', userCtrl.sessionCheck, userCtrl.getWalletBalance);
...
router.get('/vendor/profile', userCtrl.sessionCheck, userCtrl.getVendor);
...
router.get('/sessionCheck', userCtrl.clientsideSessionCheck);
